...
def test_quit_without_infinite_loop(mocker):
    Controller()
    mocker.patch(
        'calculate.view.View.get_user_input',
        return_value=5
        )
...
def test_substraction(mocker):
    ...
    mocker.patch(
        'calculate.operators.Operators.substraction',
        return_value=expected_value
        )
    mocker.patch('calculate.view.View.continue_message')
    sut.run()
...
def test_multiplication(mocker):
    ...
    mocker.patch(
        'calculate.operators.Operators.multiplication',
        return_value=expected_value
        )
    mocker.patch('calculate.view.View.continue_message')
    sut.run()
...
def test_division(mocker):
    ...
    mocker.patch(
        'calculate.operators.Operators.division',
        return_value=expected_value
        )
    mocker.patch('calculate.view.View.continue_message')
    sut.run()
